...
/// Full-screen form to edit an existing delivery address.
///
/// Pre-fills all fields from [existingAddress]. On submit it:
/// 1. Requests / checks GPS permission.
/// 2. Fetches the device's current position.
/// 3. Dispatches [CustomerAddressUpdateSubmitted] with real lat/lng.
class EditAddressPage extends StatefulWidget {
  const EditAddressPage({super.key, required this.existingAddress});
...
class _EditAddressPageState extends State<EditAddressPage> {
  ...
  void initState() {
    ...
    _nameCtrl = TextEditingController(text: a.contactName);
    _phoneCtrl = TextEditingController(text: a.contactNumber);
    _houseCtrl = TextEditingController(text: a.house);
    _floorCtrl = TextEditingController(text: a.floor);
    _streetCtrl = TextEditingController(text: a.address);
    _additionalCtrl = TextEditingController(text: a.additionalInfo);
  }
  ...
  Future<void> _submit() async {
    ...
    context.read<CustomerBloc>().add(
          CustomerAddressUpdateSubmitted(id: widget.existingAddress.id, address: updated),
        );
  }
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      leading: IconButton(
        icon: const Icon(Icons.arrow_back_ios_new_rounded, size: 18, color: AppColors.darkBrown),
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          _fetchingLocation ? 'Getting your location…' : 'Saving address…',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
...
// ── Reusable sub-widgets (mirror add_address_page.dart) ───────────────────────
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isSelected ? AppColors.primaryGreen : const Color(0xFFE0D8CE),
    ...
    return Container(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          label: Text(
            isFetchingLocation ? 'Getting Location…' : isSaving ? 'Saving…' : 'Update Address',
